...
/// <summary>
/// Data transfer object representing the detailed information of a game returned by the API to clients.
/// </summary>
/// <param name="Id">The unique identifier of the game.</param>
/// <param name="Title">The title of the game.</param>
/// <param name="Description">A detailed description of the game.</param>
/// <param name="GenreId">The unique identifier of the genre associated with the game.</param>
